    ...
    <div class="content">
        <?php echo form_open('admin/polls/delete');?>
            ...
            <?php if (is_array($polls) AND count($polls) > 0): ?>
                <table border="0" cellspacing="0" class="table-list">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo ($poll['open_date']) instanceof DateTime ? $poll['open_date']->format('Y-n-j') : '&nbsp'; ?></td>
                            <td><?php echo ($poll['close_date']) instanceof DateTime ? $poll['close_date']->format('Y-n-j') : '&nbsp'; ?></td>
                            <td><?php echo $poll['created'] instanceof DateTime ? $poll['created']->format('Y-n-j') : '&nbsp'; ?></td>
                            <td><?php echo ($poll['last_updated']) instanceof DateTime ? $poll['last_updated']->format('Y-n-j') : '&nbsp'; ?></td>
                            <td>
